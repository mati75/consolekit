...
struct _ConsoleKitSessionIface
{
  ...
  gboolean (*handle_get_xdgruntime_dir) (
    ConsoleKitSession *object,
    GDBusMethodInvocation *invocation);
...
void console_kit_session_complete_get_xdgruntime_dir (
    ConsoleKitSession *object,
    GDBusMethodInvocation *invocation,
...
void console_kit_session_call_get_xdgruntime_dir (
    ConsoleKitSession *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean console_kit_session_call_get_xdgruntime_dir_finish (
    ConsoleKitSession *proxy,
    gchar **out_xdg_runtime_dir,
    GAsyncResult *res,
    GError **error);

gboolean console_kit_session_call_get_xdgruntime_dir_sync (
    ConsoleKitSession *proxy,
    gchar **out_xdg_runtime_dir,
    GCancellable *cancellable,
    GError **error);
