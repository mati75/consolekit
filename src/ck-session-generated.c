...
static const _ExtendedGDBusArgInfo _console_kit_session_method_info_get_xdgruntime_dir_OUT_ARG_xdg_runtime_dir =
{
  {
    -1,
...
static const _ExtendedGDBusArgInfo * const _console_kit_session_method_info_get_xdgruntime_dir_OUT_ARG_pointers[] =
{
  &_console_kit_session_method_info_get_xdgruntime_dir_OUT_ARG_xdg_runtime_dir,
  NULL
};

static const _ExtendedGDBusMethodInfo _console_kit_session_method_info_get_xdgruntime_dir =
{
  {
    -1,
    (gchar *) "GetXDGRuntimeDir",
    NULL,
    (GDBusArgInfo **) &_console_kit_session_method_info_get_xdgruntime_dir_OUT_ARG_pointers,
    NULL
  },
  "handle-get-xdgruntime-dir",
  FALSE
};
...
static const _ExtendedGDBusMethodInfo * const _console_kit_session_method_info_pointers[] =
{
  ...
  &_console_kit_session_method_info_get_xdgruntime_dir,
 ...
 * @handle_get_xdgruntime_dir: Handler for the #ConsoleKitSession::handle-get-xdgruntime-dir signal.
...
console_kit_session_default_init (ConsoleKitSessionIface *iface)
{
  ...
  /**
   * ConsoleKitSession::handle-get-xdgruntime-dir:
   * @object: A #ConsoleKitSession.
   * @invocation: A #GDBusMethodInvocation.
   *
   * Signal emitted when a remote caller is invoking the <link linkend="gdbus-method-org-freedesktop-ConsoleKit-Session.GetXDGRuntimeDir">GetXDGRuntimeDir()</link> D-Bus method.
   *
   * If a signal handler returns %TRUE, it means the signal handler will handle the invocation (e.g. take a reference to @invocation and eventually call console_kit_session_complete_get_xdgruntime_dir() or e.g. g_dbus_method_invocation_return_error() on it) and no order signal handlers will run. If no signal handler handles the invocation, the %G_DBUS_ERROR_UNKNOWN_METHOD error is returned.
   *
   * Returns: %TRUE if the invocation was handled, %FALSE to let other signal handlers run.
   */
  g_signal_new ("handle-get-xdgruntime-dir",
    G_TYPE_FROM_INTERFACE (iface),
    G_SIGNAL_RUN_LAST,
    G_STRUCT_OFFSET (ConsoleKitSessionIface, handle_get_xdgruntime_dir),
    g_signal_accumulator_true_handled,
    NULL,
    g_cclosure_marshal_generic,
    G_TYPE_BOOLEAN,
...
/**
 * console_kit_session_call_get_xdgruntime_dir:
 * @proxy: A #ConsoleKitSessionProxy.
 * @cancellable: (allow-none): A #GCancellable or %NULL.
 * @callback: A #GAsyncReadyCallback to call when the request is satisfied or %NULL.
 * @user_data: User data to pass to @callback.
 *
 * Asynchronously invokes the <link linkend="gdbus-method-org-freedesktop-ConsoleKit-Session.GetXDGRuntimeDir">GetXDGRuntimeDir()</link> D-Bus method on @proxy.
 * When the operation is finished, @callback will be invoked in the <link linkend="g-main-context-push-thread-default">thread-default main loop</link> of the thread you are calling this method from.
 * You can then call console_kit_session_call_get_xdgruntime_dir_finish() to get the result of the operation.
 *
 * See console_kit_session_call_get_xdgruntime_dir_sync() for the synchronous, blocking version of this method.
 */
void
console_kit_session_call_get_xdgruntime_dir (
    ConsoleKitSession *proxy,
...
/**
 * console_kit_session_call_get_xdgruntime_dir_finish:
 * @proxy: A #ConsoleKitSessionProxy.
 * @out_xdg_runtime_dir: (out): Return location for return parameter or %NULL to ignore.
 * @res: The #GAsyncResult obtained from the #GAsyncReadyCallback passed to console_kit_session_call_get_xdgruntime_dir().
 * @error: Return location for error or %NULL.
 *
 * Finishes an operation started with console_kit_session_call_get_xdgruntime_dir().
 *
 * Returns: (skip): %TRUE if the call succeded, %FALSE if @error is set.
 */
gboolean
...
/**
 * console_kit_session_call_get_xdgruntime_dir_sync:
 * @proxy: A #ConsoleKitSessionProxy.
 * @out_xdg_runtime_dir: (out): Return location for return parameter or %NULL to ignore.
 * @cancellable: (allow-none): A #GCancellable or %NULL.
 * @error: Return location for error or %NULL.
 *
 * Synchronously invokes the <link linkend="gdbus-method-org-freedesktop-ConsoleKit-Session.GetXDGRuntimeDir">GetXDGRuntimeDir()</link> D-Bus method on @proxy. The calling thread is blocked until a reply is received.
 *
 * See console_kit_session_call_get_xdgruntime_dir() for the asynchronous version of this method.
 *
 * Returns: (skip): %TRUE if the call succeded, %FALSE if @error is set.
 */
gboolean
...
/**
 * console_kit_session_complete_get_xdgruntime_dir:
 * @object: A #ConsoleKitSession.
 * @invocation: (transfer full): A #GDBusMethodInvocation.
 * @xdg_runtime_dir: Parameter to return.
 *
 * Helper function used in service implementations to finish handling invocations of the <link linkend="gdbus-method-org-freedesktop-ConsoleKit-Session.GetXDGRuntimeDir">GetXDGRuntimeDir()</link> D-Bus method. If you instead want to finish handling an invocation by returning an error, use g_dbus_method_invocation_return_error() or similar.
 *
 * This method will free @invocation, you cannot use it afterwards.
 */
void
